...
with open('../rubicon/java/__init__.py', encoding='utf8') as version_file:
    version_match = re.search(r"^__version__ = ['\"]([^'\"]*)['\"]", version_file.read(), re.MULTILINE)
    if version_match:
...
texinfo_documents = [
    (
        'index', 'rubicon', 'Rubicon Documentation', 'Russell Keith-Magee', 'Rubicon',
        'A bridge between the Java Runtime Environment and Python.', 'Miscellaneous',
    ),
]
